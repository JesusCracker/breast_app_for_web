...
class shareDoctorSide extends React.Component {
    constructor(props) { //构造函数
        super(props);
        this.state = {
            loading: true,
            iswx: false,
            downloadtitle: '你已安装乳腺好大夫-医生版APP',
            downloadlink: 'https://itunes.apple.com/cn/app/id1449439150?mt=8',
            downloadtext: '下载乳腺好大夫-医生版APP',
        }
    }
    ...
    getData() {
        ...
        if (self.isWeiXin && isIOS && !isAndroid) {
            ...
            if (isAndroid) {
                _this.setState({
                    downloadlink: 'https://aihis.aisono.cn/platfile/appApK/app-doctor.apk',
                });
            } else if (isIOS) {
                _this.setState({
                    downloadlink: 'https://itunes.apple.com/cn/app/id1449439150?mt=8',
            ...
            if (isIOS) {
                ...
                // 		_this.setState({
                // 			downloadlink: 'https://apps.apple.com/cn/app/乳腺好大夫-医生版/id1449439150',
                // 		});
                ...
                <DocumentTitle title='乳腺好大夫简介'>
                    <div style={{width: '100%', height: '100%', backgroundColor: '#ffffff', position: 'relative'}}>
                        ...
                        >
                            ...
                            >
                                <img src={require("../images/doctorapp_logo.png")} alt="logo"
                        ...
                        >
                            <img src={require("../images/doctorshare_bg.png")} alt="img"
...
export default shareDoctorSide;
