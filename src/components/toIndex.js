...
class ToIndex extends Component {
    ...
    render() {
        ...
        if(this.getQueryString().type&&this.getQueryString().type.indexOf('index')!==-1){

            //重定向到问诊列表
            return(
                <Redirect to={`/TabBarMenu/${this.getGroupNum(this.getQueryString().type)}`}/>
            )
        }
