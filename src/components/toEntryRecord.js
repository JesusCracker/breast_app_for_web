...
class ToEntryRecord extends Component {
    ...
    render() {
        ...
        if(this.getQueryString().type&&this.getQueryString().type==='entryRecord'){
            //重定向到订单列表
            return(
                <Redirect to={"/entryRecord/"} />
            )
        }
